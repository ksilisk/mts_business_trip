...
INSERT INTO Hotels (name, city) VALUES ('Cosmos', 'SPB');


INSERT INTO Rooms (hotel_id, room_number, price) VALUES
                                                     ((SELECT id FROM Hotels WHERE name = 'Cosmos'), 101, 1500),
                                                     ((SELECT id FROM Hotels WHERE name = 'Cosmos'), 102, 2000),
                                                     ((SELECT id FROM Hotels WHERE name = 'Cosmos'), 103, 2500);


INSERT INTO Flights (flight_number, departure_city, arrival_city, departure_time, arrival_time, price, airline) VALUES
                                                      (12345, 'MSK', 'SPB', '2024-04-12 08:00:00', '2024-04-12 10:00:00', 10000, 'Aeroflot'),
